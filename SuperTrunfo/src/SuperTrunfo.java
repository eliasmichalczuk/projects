...
public class SuperTrunfo {
	...
	public void jogo() {
		...
		do{
			...
			if(_vencedor == 2 || _vencedor == 0){
				...
				while(jogador.opcaoAtual < 1 || jogador.opcaoAtual > 5) {
					System.out.println("\nEscolha um atributo");
	...
	public static int algoritmo(ArrayList<Carta> cartas) {
		...
		/*for (int i=0; i < valores.length; i++) {
	       valores[i] = valores[i]/count;
	    }*/
		
		valores[0] = velocidade/count;
		valores[1] = autonomia/count;
		valores[2] = comprimento/count;
		valores[3] = envergadura/count;
		valores[4] = pesoDecolagem/count;
